...
use andromeda_vault::mock::{mock_andromeda_vault, mock_vault_instantiate_msg};
...
fn mock_app() -> App {
    ...
    App::new(|router, _api, storage| {
        ...
        router
            .bank
            .init_balance(storage, &buyer_one, [coin(100, "uandr")].to_vec())
            .unwrap();
        router
            .bank
            .init_balance(storage, &buyer_two, [coin(100, "uandr")].to_vec())
            .unwrap();
        router
            .bank
            .init_balance(
